<template>
  <div :class="classes" v-clickoutside="handleClose">
    <div :class="[prefixCls + '-rel']" @click="toggleOpen" ref="reference">
      ...
      <Input @on-focus="handleFocus" @on-change="handleInput" :element-id="elementId" ref="input" class="text-ellipsis" :title="displayInputRender" :readonly="!filterable" :disabled="disabled" :value="displayInputRender" :size="size" :placeholder="inputPlaceholder" />
